...
mkdir -p classes
javac -cp $CLASSPATH src/main/java/scanner/*.java src/main/java/parser/*.java src/main/java/compiler/*.java src/test/java/*.java src/main/java/ast/*.java src/main/java/visitor/*.java -d classes/
