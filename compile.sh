...
mkdir -p classes
javac -cp $CLASSPATH src/main/java/*.java src/test/java/*.java src/main/java/ast/*.java src/main/java/compiler/*.java src/main/java/visitor/*.java src/main/java/parser/*.java -d classes/
